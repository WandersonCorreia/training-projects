...
def legendar(arq_video, contexto):
    ...
    with tempfile.NamedTemporaryFile(delete=False, suffix=".mp4") as temp_video:
        temp_video.write(arq_video.read())
    ...
    try:
        audio = AudioSegment.from_file(temp_video_path, format=ext_arq)
    ...
    # transcrição do video com OPENAI
    ...
    try:
        ...
        with open(audio_path, "rb") as arquivo:
            # o "rb" é um comando de abertura de leitura em bytes. que é como a IA entende
